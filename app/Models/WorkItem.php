...
class WorkItem extends Model
{
    ...
    public const DEPENDENCIES = [
        // [السابق, اللاحق]
        // ملابن الأبواب يجب أن تكون قبل اللياسة والنجارة النهائية
        ['ملابن الأبواب', 'طينة / لياسة'],
        ['ملابن الأبواب', 'أبواب ون جارة'    ],

        // تمديدات السواد قبل إغلاق وتشطيب  الجدران
        ['تمديدات صحية سواد', 'طينة / لياسة'],
        ['تمديدات كهرباء سواد', 'طينة / لياسة'],
        
        // الطينة تسبق السيراميك في ترتيب القائمة،
        // لكن يمكن تشغيل البندين معاً
        // ['طينة / لياسة', 'سيراميك جدران / أسقف'],
        
        // التمديدات المخفية قبل الأعمال التي تغطيها
        ['تمديدات صحية سواد', 'سيراميك جدران / أسقف'],
        ['تمديدات صحية سواد', 'بلاط أرضيات'],
        ['تمديدات كهرباء سواد', 'جبس بورد'],
        
        // أعمال الأسقف والجدران قبل الدهان
        ['طينة / لياسة', 'دهان'],
        ['جبس بورد', 'دهان'],
        
        // السيراميك قبل بلاط الأرضيات
        ['سيراميك جدران / أسقف', 'بلاط أرضيات'],
        
        // حسب الترتيب المعتمد للمشروع
        ['بلاط أرضيات', 'ألمنيوم وأبجورات'],
        ['بلاط أرضيات', 'أبواب ونجارة'],
        ['ألمنيوم وأبجورات', 'دهان'],
        ['أبواب ونجارة', 'دهان'],
        
        // أعمال البياض بعد الدهان
        ['دهان', 'تمديدات كهرباء بياض'],
        ['دهان', 'تمديدات صحية بياض'],
        
        // الصحي البياض بعد إنهاء السيراميك والبلاط
        ['سيراميك جدران / أسقف', 'تمديدات صحية بياض'],
        ['بلاط أرضيات', 'تمديدات صحية بياض'],
        
        // كل التمديدات النهائية بعد تمديدات السواد الموافقة لها
        ['تمديدات كهرباء سواد', 'تمديدات كهرباء بياض'],
        ['تمديدات صحية سواد', 'تمديدات صحية بياض'],
        
        // الديكورات في النهاية
        ['دهان', 'ديكورات'],
        ['تمديدات كهرباء بياض', 'ديكورات'],
        ['تمديدات صحية بياض', 'ديكورات'],
        ['ألمنيوم وأبجورات', 'ديكورات'],
        ['أبواب ونجارة', 'ديكورات'],
